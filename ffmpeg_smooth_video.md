...
ffmpeg -i ben5.mp4 -filter:v "select=mod(n\,2)" -c:v h264 -c:a copy ben6.mp4
ffmpeg -i ben6.mp4 -filter:v "select=mod(n\,2)" -c:v h264 -c:a copy ben7.mp4
